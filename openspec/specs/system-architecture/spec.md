...
Defines the technical architecture for the fulltime football management simulation, including tech stack choices, server/client structure, data flow patterns, and bot decision state machines.
