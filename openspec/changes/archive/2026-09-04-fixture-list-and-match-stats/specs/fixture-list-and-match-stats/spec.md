...
## Non-Goals
- Live/in-progress match stats — matches are only displayed after simulation completes
- Historical aggregate stats across multiple matches (e.g., season-wide team stats)
- Advanced metrics like possession percentage or expected goals (xG)
